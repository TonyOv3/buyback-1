	  ...
	  <div class="wrap">
		<div class="row phone-details modern-style-image">
		  <div class="col-md-12 phone-details-height">
                ...
                <div class="row">
                	<div class="col-sm-12 mt20 text-right"><button type="submit" class="btn btn_md btn-blue-bg" name="update_cart" id="update_cart" onclick="return check_update_cart();">Upadate Cart</button></div>
                </div>
